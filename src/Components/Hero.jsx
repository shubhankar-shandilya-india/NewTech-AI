    ...
    return (
        <div className='flex flex-col items-center'>
            ...
            <div className='pt-6 flex gap-[2vw] sm:gap-[1vw]'>
                <button className='px-4 flex items-center glow-on-hover text-xs sm:text-sm md:text-base '>Explore AI Solutions →</button>
                <button className='px-4 flex items-center glow-on-hover text-xs sm:text-sm md:text-base '>Get Started Today →</button>
            </div>
        </div>
    );
};
