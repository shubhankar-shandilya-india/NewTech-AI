...
const Hero = () => {
    ...
    return (
        <div className='flex flex-col items-center mb-9 pb-9' ref={app}>
            ...
            <div class="h1 pt-6 font-sans text-base text-[#F5F5F5] px-4 font-medium leading-normal lg:text-lg md:w-11/12 lg:w-full text-center lg:max-w-[800px] ">Unleashing the Power of AI to Transform Your Business</div>
            <div class="h1 pt-6 font-sans text-base text-[#F5F5F5] px-4  font-medium leading-normal lg:text-lg md:w-11/12 lg:w-full text-center lg:max-w-[800px] mx-auto">At NewTech ai, we harness the synergy of advanced AI algorithms and deep learning to turn your data into actionable insights. Step into a new era of innovation and intelligence tailored for startups and growing enterprises.</div>
