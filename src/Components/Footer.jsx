                        ...
                        <ul className="grid grid-cols-2 gap-y-2 gap-x-10 md:gap-10 xl:gap-0 md:grid-cols-3 xl:justify-between xl:flex xl:flex-wrap">
                            <li className="mb-8 md:w-auto md:mb-0">
                                ...
                                <ul>
                                    ...
                                    <li className="flex mb-3 text-xs md:text-sm md:mb-3">
                                        <a className="font-normal text-neutral-400 hover:text-white" href="https://exchange.kalitechai.com/">Community</a>
                                    </li>
                                    <li className="flex mb-3 text-xs md:text-sm md:mb-3">
                            ...
                            <li className="mb-8 md:w-auto md:mb-0">
                                ...
                                <ul>
                                    <li className="flex mb-3 text-xs md:text-sm md:mb-3">
                                        <a className="font-normal text-neutral-400 hover:text-white" href="/data-engine">kalitechai Data Engine</a>
                                    </li>
                                    <li className="flex mb-3 text-xs md:text-sm md:mb-3">
                                        <a className="font-normal text-neutral-400 hover:text-white" href="/genai-platform">kalitechai GenAI Platform</a>
                                    </li>
                                    <li className="flex mb-3 text-xs md:text-sm md:mb-3">
                                        <a className="font-normal text-neutral-400 hover:text-white" href="/donovan">kalitechai Donovan</a>
                                    </li>
                                </ul>
                            </li>
                            <li className="mb-8 md:w-auto md:mb-0">
                            ...
                            <li className="mb-8 md:w-auto md:mb-0">
                                ...
                                <ul>
                                    <li className="flex mb-3">
                                        <a className="font-normal text-xs md:text-sm text-neutral-400 hover:text-white" href="/sales">sales@kalitechai.com</a>
                                    </li>
                                    ...
                                    <li className="flex mb-3 text-xs md:text-sm">
                                        <a href="mailto:careers@kalitechai.com" className="font-normal  text-neutral-400 hover:text-white">careers@kalitechai.com</a>
                                    </li>
                                    <li className="flex mb-3 text-xs md:text-sm">
                                        <a href="mailto:press@kalitechai.com" className="font-normal  text-neutral-400 hover:text-white">press@kalitechai.com</a>
                                    </li>
                                    <li className="flex gap-3 mt-8 text-neutral-400">
                                        <a aria-label="Twitter" href="https://x.com/kalitechai_ai">
                                        ...
                                        <a aria-label="Facebook" href="https://www.facebook.com/kalitechaiapi">
                                        ...
                                        <a aria-label="LinkedIn" href="https://www.linkedin.com/company/kalitechaiai">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 duration-300 ease-in-out fill-current transition-color hover:text-white">
